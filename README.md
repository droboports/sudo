...
Check the [releases](https://github.com/droboports/sudo/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/sudo.git
cd sudo
./build.sh
```
